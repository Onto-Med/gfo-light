...
**Tokens** are specific objects that instantiate a symbolic structure.
These are not only texts, but generally representations or specifications, such as a UML model or a computer programme.
Tokens represent other entities (*represents/representedBy*).
